    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <div class="card"
                    style="background-image: url({{ Vite::asset('resources/assets_frontend/') }}img/values-1.jpg);">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="100">
                <div class="card"
                    style="background-image: url({{ Vite::asset('resources/assets_frontend/') }}img/values-2.jpg);">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card"
                    style="background-image: url({{ Vite::asset('resources/assets_frontend/') }}img/values-3.jpg);">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="300">
                <div class="card"
                    style="background-image: url({{ Vite::asset('resources/assets_frontend/') }}img/values-4.jpg);">
                    <div class="card-body">
