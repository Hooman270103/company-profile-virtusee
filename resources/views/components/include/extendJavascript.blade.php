<script>
    $(document).ready(function() {
        ...
        if ($.fn.summernote) {
            $('textarea[name="content"]').summernote({
                ...
                fontNames: ['Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', 'DM sans', 'Merriweather' ,'Open Sans', 'Roboto', 'Tahoma', 'Times New Roman', 'Verdana'],
                fontSizes: ['8', '9', '10', '11', '12', '14', '16', '18', '20', '22', '24', '26', '28', '36', '48', '64', '82', '150'],
                callbacks: {
                    onInit: function() {
                        // Set default font
    ...
    function doTheUpload(uploadedImage, myEditor) {
        ...
        requestAjax("{{ route('summernote.upload') }}", {
            dataForm: formData,
        }, "POST", "TEXT", function(imageUrl) {
